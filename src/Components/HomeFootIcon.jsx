...
const HomeFootIcon =()=> {
  ...
  return (
    <>
        ...
        <img src={userstats} alt="" onClick={() => handleIconClick('/user-stats')} />
        <img src={category} alt="" onClick={() => handleIconClick('/category')}/>
        <img src={leaderboard} alt="" onClick={() => handleIconClick('/leaderboard')}/>
        <img src={rules} alt="" onClick={() => handleIconClick('/rules-faqs')}/>
      </div>
    </>
  )
}
