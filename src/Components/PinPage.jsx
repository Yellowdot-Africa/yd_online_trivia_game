...
//   const [isForgotPinModalOpen, setIsForgotPinModalOpen] = useState(false);
//   const [isResetPinModalOpen, setIsResetPinModalOpen] = useState(false);
//   const hasTransactionPIN = useSelector((state) => state.auth.hasTransactionPIN);
...
//     // setIsPinCreated(hasTransactionPIN);
//   }, [hasTransactionPIN]);

//   console.log("isPinCreated:", isPinCreated);  // Check the value of isPinCreated
// console.log("isPinVerified:", isPinVerified);  // Check the value of isPinVerified
...
//   //       }
//   //     );
//   //     setIsPinCreated(true); // Update the state once the PIN is successfully created
//   //   } catch (error) {
//   //     if (error.response?.data?.statusMessage === "DataAlreadyExist") {
//   //       setErrorMessage("You already have a transaction PIN.");
//   //       setIsPinCreated(true); // In case of any data conflict, update the flag
//   //     } else {
//   //       setErrorMessage("Failed to create PIN. Please try again.");
//   //     }
//   //   }
