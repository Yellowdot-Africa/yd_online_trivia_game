...
//   const toggleMenu = () => {
//     setMenuOpen(!isMenuOpen);
//     setShowLogin(true); // Show login form by default when menu opens
//   };

//   const closeMenu = () => {
//     setMenuOpen(false);
//     setShowLogin(true); // Reset to login form when menu is closed
//   };
...
//             <ul className="menu-list">
//               <li className="menu-item" onClick={toggleLoginForm}>
//                 <div className={`form-tab ${showLogin ? 'active' : ''}`}>
//                   <img src={Login} alt="login" />
//                   Login
//                 </div>
//               </li>
...
//               {!showLogin && <SignUpForm isSignUpOpen={true} navigateToLogin={navigateToLogin} />}
//             </div>
